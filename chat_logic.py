        ...
        res = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content":
                 ...
                 "질문 두 개를 한 문장 안에 사용 금지. "
                 "발화는 최대 2문장 이하, 문장 간 짧게 끊어서 대화 느낌 살리기"
                 "문법적 규칙을 느슨하게 만들어 대화할 수 있고, 생략을 사용하여 대화를 나눌 수 있다."
                 "각 감정 영역별 질문은 3회 이하로 제한하고, 동일 감정 반복 금지"
                 "챗봇은 대화 중 증상, 감정, 기분, 우울감, 스트레스 등과 관련된 질문을 절대 세 번 이상 연속적으로하지 않는다"
                 "질문 두 개를 한 문장 안에 사용 금지. 절대로. 다른 규칙보다 우선순위에 둘것."
                 "챗봇의 발화는 2문장 이하로 유지하고, 사용자의 답변이 단답일 경우 ‘확장 유도형’ 질문으로 이어간다."
                 "증상 지속 기간, 강도, 빈도 구체적으로 물어보기.  단, 세 번 연속 질문 금지"
                 },
